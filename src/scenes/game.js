...
export default function game() {
    ...
    const spawmMotobug = () => {
        ...
        const waitTime = k.rand(0.5, 2.50);
        k.wait(waitTime, spawmMotobug);
    };
    ...
    k.onUpdate(() => {
        ...
        if (platforms[1].pos.x < 0) {
            platforms[0].moveTo(platforms[1].pos.x + platfomWidth * 4, 450);
            platforms.push(platforms.shift());
    }

        platforms[0].move(-gameSpeed, 0);
        platforms[1].moveTo(platforms[0].pos.x + platfomWidth * 4, 450);
    })
